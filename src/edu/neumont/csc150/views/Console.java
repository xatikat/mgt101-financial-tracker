...
public class Console {
    ...
    public static LocalDate getDateInput(String message, TextColor textColor) {
        do {
            ...
            int month = getIntInput("Enter month (1-12): ",1, 12, textColor);
            int day = getIntInput("Enter day (1-31): ", 1, 31, textColor);
            int year = getIntInput("Enter year: ", 1000, 9999, textColor);
